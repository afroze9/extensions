...
internal sealed class RedactionBuilder : IRedactionBuilder
{
    ...
    public IRedactionBuilder SetRedactor<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(params DataClassification[] classifications)
        where T : Redactor
    {
